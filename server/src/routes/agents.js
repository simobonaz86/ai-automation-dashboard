...
router.post('/:id/clone', (req, res) => {
  try {
    ...
    console.error('POST /agents/:id/clone error:', err);
    res.status(500).json({ error: err.message });
  }
});
...
router.put('/:id/assignments', (req, res) => {
  try {
    ...
    console.error('PUT /agents/:id/assignments error:', err);
    res.status(500).json({ error: err.message });
  }
});
...
router.put('/:id/profiles', (req, res) => {
  try {
    ...
    console.error('PUT /agents/:id/profiles error:', err);
    res.status(500).json({ error: err.message });
  }
});
...
router.get('/:id/curve', (req, res) => {
  try {
    ...
    console.error('GET /agents/:id/curve error:', err);
    res.status(500).json({ error: err.message });
  }
});
